/*
  ...
  - A unique constraint covering the columns `[userId,endpoint]` on the table `NotificationSubscription` will be added. If there are existing duplicate values, this will fail.
